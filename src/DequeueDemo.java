...
public class DequeueDemo {
    public static void main(String[] args) {
        ...
        //it is an array so elements stored at contiguous memory locations, so faster access.
        //no nodes so low memory
        // array is circular, have two pointers head and tail
        //so after removing the first element
        // no need to shift elements, just shift head and tail
        deque1.addFirst(10); // after doing addFirst first  head is subtracted 1 , at that index ele
        // is added
        //if initially head is at 0 index , and if it happens head-- so head goes at end
        //similarly tail comes at starting.
        deque1.addLast(20);
        deque1.offerFirst(5);
        deque1.offerLast(25);
        // 5, 10, 20, 25
        ...
        Deque<Integer> deque2 = new LinkedList<>(); // used when insertion, deletion somewhere in middle
